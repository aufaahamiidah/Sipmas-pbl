                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-panel">
                            <span class="timeline-date">2024-02-08</span>
                            <span class="timeline-status">Draf</span>
                        </div>
                    </li>
                    <li>
                        <div class="timeline-panel">
                            <span class="timeline-date">2024-02-12</span>
                            <span class="timeline-status">Diusulkan</span>
                        </div>
                    </li>
                    <li>
                        <div class="timeline-panel">
                            <span class="timeline-date">2024-04-12</span>
                            <span class="timeline-status">Perbaikan Berkas</span>
                        </div>
                    </li>
                    <li>
                        <div class="timeline-panel">
                            <span class="timeline-date">2024-04-18</span>
                            <span class="timeline-status">Diusulkan</span>
                        </div>
                    </li>
                    <li>
